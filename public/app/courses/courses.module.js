System.register(["@angular/core", "@angular/common", "@angular/forms", "@angular/router", "./courses.routes", "./courses.component", "./create/create.component", "./list/list.component", "./view/view.component", "./edit/edit.component", "./listAllCourses/listAllCourses.component", "./listAllStudents/listAllStudents.components"], function (exports_1, context_1) {
    ...
    var core_1, common_1, forms_1, router_1, courses_routes_1, courses_component_1, create_component_1, list_component_1, view_component_1, edit_component_1, listAllCourses_component_1, listAllStudents_components_1, CoursesModule;
